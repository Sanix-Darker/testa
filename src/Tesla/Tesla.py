...
class Tesla:
    ...
    def start(self):
        ...
        self.TeslAssertClass += "\n"+self.varDeclaration+"tesla = "+self.classInstantiationNew+"TeslaAssertpython()"+self.semicolomn
